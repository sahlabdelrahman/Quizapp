...
class Play extends Component {
    ...
    componentDidMount(){
        ...
        this.displayQuestion(questions, nextQuestion, currentQuestion, previousQuestion);
        this.startTimer();
    }
    ...
    handleQuitButtonClick = () => {
        this.playButtonSound();
        if(window.confirm('Are you sure yoy want to quit?')){
    ...
    handleHints  = () => {
        ...
        if(this.state.hints > 0){
            ...
            while(true){
                ...
                if(this.state.previousRandomNumbers >= 3) break;
            }
        }
    ...
    startTimer = () => {
        const countTimeDown = Date.now() + 180000;
        this.interval = setInterval(() => {
            const now = new Date();
            const distance = countTimeDown - now ;
    ...
    render(){
        ...
        return(
            <Fragment>
                <Helmet><title>Quiz Pages</title></Helmet>
                <Fragment>
                    <audio ref={this.wrongSound} src={wrongAnswer}></audio>
                    <audio ref={this.correctSound} src={correctAnswer}></audio>
                ...
                <div className='questions'>
                    ...
                    <div className='lifeline-container'>
                        <p>
                            <span onClick={this.handleFiftyFifty} className='mdi mdi-set-center lifeline-icon mdi-24px'>
                                <span className='lifeline'>{fiftyFifty}</span>
                            </span>
                        </p>
                        <p>
                            <span onClick={this.handleHints} className='mdi mdi-lightbulb-on-outline lifeline-icon mdi-24px'>
